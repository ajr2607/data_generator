...
# print(sorted_data_airports_only.groupby(['country_name', 'timezone']).mean())

no_dups_data = data[~data.duplicated()]

afghanistan = data_airports_only[data_airports_only['country_name'].str.contains('Afghanistan')]
print(afghanistan)
